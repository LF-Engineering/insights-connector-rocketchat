...
./rocketchat --rocketchat-url='https://chat.hyperledger.org' --rocketchat-channel='sawtooth' --rocketchat-es-url="${ESURL}" --rocketchat-debug=0 --rocketchat-user="`cat ./secrets/user.encrypted.secret`" --rocketchat-token="`cat ./secrets/token.encrypted.secret`" --rocketchat-stream="${STREAM}" $*
...
#./rocketchat --rocketchat-url='https://chat.enarx.dev' --rocketchat-channel='general' --rocketchat-es-url="${ESURL}" --rocketchat-debug=0 --rocketchat-user="`cat ./secrets/user-ccc.encrypted.secret`" --rocketchat-token="`cat ./secrets/token-ccc.encrypted.secret`" --rocketchat-stream="${STREAM}" $*
