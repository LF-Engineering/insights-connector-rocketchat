GO_BIN_FILES=cmd/rocketchat/rocketchat.go 
...
BINARIES=rocketchat
all: check ${BINARIES}
rocketchat: ${GO_BIN_FILES}
	 ${GO_ENV} ${GO_BUILD} -o rocketchat ${GO_BIN_FILES}
fmt: ${GO_BIN_FILES}
	${GO_FMT} ${GO_BIN_FILES}
lint: ${GO_BIN_FILES}
...
swagger: clean_swagger
	swagger -q generate model -t gen -f swagger/rocketchat.yaml
clean_swagger:
	rm -rf ./gen
	mkdir gen
clean:
